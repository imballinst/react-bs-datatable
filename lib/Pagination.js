...
function Pagination(_a) {
    var rowsPerPage = _a.rowsPerPage, currentPage = _a.currentPage, onPageNavigate = _a.onPageNavigate, labels = _a.labels, maxPage = _a.maxPage, classes = _a.classes;
    ...
    if (rowsPerPage !== undefined && maxPage !== undefined) {
        ...
        buttons.push(react_1.default.createElement(NavButton_1.default, { className: classes.paginationButton, key: "page-" + firstLabel, pageNumber: 1, disabled: !hasPrev, onPageNavigate: paginateHandler, label: firstLabel }), react_1.default.createElement(NavButton_1.default, { className: classes.paginationButton, key: "page-" + prevLabel, 
        ...
        if (!isCurrentPageOutOfBounds) {
            while (i < 3 && startNumber <= maxPage) {
                ...
                buttons.push(react_1.default.createElement(NavButton_1.default, __assign({}, pageBtnProps)));
                i += 1;
                startNumber += 1;
            }
        }
            ...
            hasNext = false;
            buttons.push(react_1.default.createElement(NavButton_1.default, { key: "page-btn-" + startNumber, className: classes.paginationButton, pageNumber: currentPage - 1, disabled: true, onPageNavigate: paginateHandler, label: currentPage }));
        }
        buttons.push(react_1.default.createElement(NavButton_1.default, { className: classes.paginationButton, key: "page-" + nextLabel, pageNumber: currentPage + 1, disabled: !hasNext, onPageNavigate: paginateHandler, label: nextLabel }), react_1.default.createElement(NavButton_1.default, { className: classes.paginationButton, key: "page-" + lastLabel, pageNumber: maxPage, disabled: !hasNext, onPageNavigate: paginateHandler, label: lastLabel }));
        renderedElements = (react_1.default.createElement(ButtonGroup_1.default, { className: classes.paginationButtonGroup }, buttons));
    }
