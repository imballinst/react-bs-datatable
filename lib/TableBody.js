...
function TableBody(_a) {
    var tableHeaders = _a.tableHeaders, labels = _a.labels, data = _a.data, classes = _a.classes, _b = _a.components, TableBody = _b.TableBody, TableRow = _b.TableRow, TableCell = _b.TableCell;
    var body = [];
    ...
    if (dataLength !== 0) {
        for (var i = 0; i < dataLength; i += 1) {
            body.push(react_1.default.createElement(BodyRow_1.default, { key: "row-" + i, classes: classes, components: {
                    TableRow: TableRow,
                    TableCell: TableCell
                }, tableHeaders: tableHeaders, data: data, rowIdx: i }));
        }
    }
    else {
