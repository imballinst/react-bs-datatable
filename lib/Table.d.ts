 ...
 **/
export declare function useDatatableLifecycle({ initialSort, onSort, onFilter, rowsPerPage, rowsPerPageOption, async, tableHeaders, classes, tableBody, labels, Components }: DatatableProps): {
    data: any[];
