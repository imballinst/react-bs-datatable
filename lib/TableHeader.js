...
function TableHeader(_a) {
    var tableHeaders = _a.tableHeaders, sortedProp = _a.sortedProp, onSortChange = _a.onSortChange, classes = _a.classes;
    ...
    return (react_1.default.createElement("thead", { className: object_1.makeClasses('thead', classes.thead) },
        react_1.default.createElement("tr", { className: object_1.makeClasses('thead-tr', classes.theadRow) }, headings)));
}
