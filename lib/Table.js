...
function Datatable(_a) {
  var initialSort = _a.initialSort,
    ...
    _b = _a.rowsPerPage,
    rowsPerPage = _b === void 0 ? 5 : _b,
    _c = _a.rowsPerPageOption,
    rowsPerPageOption = _c === void 0 ? [] : _c,
    tableHeaders = _a.tableHeaders,
    tableBody = _a.tableBody,
    _d = _a.tableBsClass,
    tableBsClass = _d === void 0 ? '' : _d,
    _e = _a.labels,
    labels = _e === void 0 ? {} : _e;
  ...
  function onChangeFilter(text) {
    setState(function(oldState) {
      return __assign({}, oldState, { filterText: text, currentPage: 1 });
    });
  }
  function onPageNavigate(nextPage) {
    return function() {
      setState(function(oldState) {
        return __assign({}, oldState, { currentPage: nextPage });
      });
    };
  }
  ...
  function onSortChange(nextProp) {
    return function() {
      ...
      setState(function(oldState) {
        return __assign({}, oldState, { sortedProp: nextSort });
      });
    };
  }
  var filteredData = data_1.filterData(
    tableBody,
    tableHeaders,
    state.filterText,
    onFilter
