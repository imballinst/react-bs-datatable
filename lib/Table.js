...
function useDatatableLifecycle(_a) {
    var initialSort = _a.initialSort, onSort = _a.onSort, onFilter = _a.onFilter, rowsPerPage = _a.rowsPerPage, rowsPerPageOption = _a.rowsPerPageOption, async = _a.async, tableHeaders = _a.tableHeaders, _b = _a.classes, classes = _b === void 0 ? {} : _b, tableBody = _a.tableBody, _c = _a.labels, labels = _c === void 0 ? {} : _c;
    ...
    function onSortChange(nextProp) {
        if (async && async.onSort) {
            ...
            setState(function (oldState) { return (__assign({}, oldState, { sortedProp: nextSort_1 })); });
        }
    }
    var data = tableBody;
    var maxPage;
...
function Datatable(props) {
    var _a = useDatatableLifecycle(props), data = _a.data, rowsPerPageOption = _a.rowsPerPageOption, tableHeaders = _a.tableHeaders, onChangeFilter = _a.onChangeFilter, onPageNavigate = _a.onPageNavigate, classes = _a.classes, onRowsPerPageChange = _a.onRowsPerPageChange, onSortChange = _a.onSortChange, tableClass = _a.tableClass, labels = _a.labels, filterable = _a.filterable, filterText = _a.filterText, rowsPerPage = _a.rowsPerPage, currentPage = _a.currentPage, sortedProp = _a.sortedProp, maxPage = _a.maxPage;
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(Row_1.default, { className: object_1.makeClasses('controlRow__root', classes.controlRow) },
            react_1.default.createElement(Col_1.default, { xs: 12, md: 4, className: classes.filterCol },
                react_1.default.createElement(Filter_1.default, { filterable: filterable, classes: classes, placeholder: labels.filterPlaceholder, onChangeFilter: onChangeFilter, filterText: filterText })),
            react_1.default.createElement(Col_1.default, { xs: 12, md: 3, className: classes.paginationOptsCol },
                react_1.default.createElement(PaginationOpts_1.default, { classes: classes, labels: labels, onRowsPerPageChange: onRowsPerPageChange, rowsPerPage: rowsPerPage, rowsPerPageOption: rowsPerPageOption })),
            react_1.default.createElement(Col_1.default, { xs: 12, md: 5, className: object_1.makeClasses('text-right', classes.paginationCol) },
                react_1.default.createElement(Pagination_1.default, { maxPage: maxPage, classes: classes, rowsPerPage: rowsPerPage, currentPage: currentPage, onPageNavigate: onPageNavigate, labels: labels }))),
        react_1.default.createElement(Row_1.default, null,
            react_1.default.createElement(Col_1.default, { xs: "12" },
                react_1.default.createElement(Table_1.default, { className: tableClass },
                    react_1.default.createElement(TableHeader_1.default, { classes: classes, tableHeaders: tableHeaders, sortedProp: sortedProp, onSortChange: onSortChange }),
                    react_1.default.createElement(TableBody_1.default, { classes: classes, tableHeaders: tableHeaders, labels: labels, data: data }))))));
}
