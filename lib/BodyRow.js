...
function BodyRow(_a) {
    var tableHeaders = _a.tableHeaders, data = _a.data, rowIdx = _a.rowIdx, classes = _a.classes, components = _a.components;
    var row = [];
    ...
    return (react_1.default.createElement(components.TableRow, { className: object_1.makeClasses('tbody-tr', classes.tbodyRow) }, row));
}
